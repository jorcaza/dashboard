		...
		<div class="col-md-6 chart-layer1-left"> 
			...
			<div class="span-2c">  
                        ...
                        <canvas id="bar" height="300" width="400" style="width: 400px; height: 300px;"></canvas>
 							<!--<a data-toggle="modal" data-target="#myModal">Meses Anteriores</a>-->
...
<!--slider menu-->
    <div class="sidebar-menu">
		  	<div class="logo"> <a href="#" class="sidebar-icon"> <span class="fa fa-exchange"></span> </a> <a href="#"> <span id="logo" ></span> 
			      <!--<img id="logo" src="" alt="Logo"/>--> 
			  </a> </div>		  
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="index.html"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
		        <li><a href="#"><i class="fa fa-cogs"></i><span>Censos En Línea</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
		            <li><a href="grids.html">Hospitalizacion</a></li>
		            <li><a href="portlet.html">Cuidado INTERMEDIO</a></li>		            
		          </ul>
		        </li>
