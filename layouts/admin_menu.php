<ul>
  ...
  <li>
    <a href="#" class="submenu-toggle">
      ...
      <ul class="nav submenu">
         <li><a href="../../../INTRANET2" target="_blank">Hospitalizacion</a></li>
         <li><a href="http://intranet:81/intranet/siinfo/medica/uci/censo/indexIntermedios.html#/">UCI INTERMEDIO</a> </li>
         <li><a href="http://intranet:81/intranet/siinfo/medica/uci/censo/#/">UCI INTENSIVO</a> </li>
     </ul>
  </li>
  <li>
    <a href="#" class="submenu-toggle">
