...
<table width="840" border="0" align="center">
  <tr>
    ...
    <td><div align="center" class="Estilo2"><span class="Estilo3"><?php echo $iduf.' ('.$unid.')'.' - '.$año; ?>
      </span>
    </div>
...
<table width="98%" border="0" cellspacing="0" cellpadding="3" align="center">
  <tr> 
    ...
    <script type="text/javascript">
		   ...
		   chart.setDataURL("Data/Col3DLineDY.php?var1=<?php echo $idvariable.$año; ?>&var2=<?php echo $año; ?>");		   
